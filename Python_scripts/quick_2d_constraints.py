...
def ideal_distances_analysis(z_min=0.2, z_max=2.0, N_events=20, z_method='rates', Ho_res=50, Om_res=40, w_res=45, fit='2D'):
    ...
    if fit=='2D':
        ...
        return z_obs, DM_values_obs, chi_fit_2D, H_Om, Om_H0, H0_array, P_H0
        ...
        return z_obs, DM_values_obs, H_Om, Om_H0, H_w, w_H, Om_w, w_Om, chi_2D_H0Om, chi_2D_H0w, chi_2D_Omw, P2d_H0Om, P2d_H0w, P2d_Omw, t_contours_H0Om, t_contours_H0w, t_contours_Omw
...
def bayesian_H0_analysis(z_min=0.2, z_max=2.0, N_events=20, z_method='rates', Ho_res=180):
    """
    Function that automates our analysis: Recovers H0 posterior.

    Here we assume luminosity distances and DMs with realistic errors. We use a bayesian approach to marginalise over redshift.
    """
