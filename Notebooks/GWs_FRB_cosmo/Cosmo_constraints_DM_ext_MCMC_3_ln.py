...
# # DM_ext - dL constraints for z<0.2 with log-normal distribution
...
RESUME = False
CKP_INTERVAL = 50
DATA_FILE = './checkpoint/data_3.pkl'
MCMC_FILE = './checkpoint/mcmc_dm_ext_3_ln_checkpoint.pkl'

# savefile
SAVE_RESULT='./posterior/MCMC_DM_ext_3_ln.npy'
SAVE_FIG='./plot/MCMC_DM_ext_3_ln'
...
if os.path.exists(DATA_FILE):
    ...
    # DM_ext data
    DM_ext_obs = saved_data['DM_ext_obs_ln']
    sigma_DM_ext = saved_data['sigma_DM_ext_ln']
