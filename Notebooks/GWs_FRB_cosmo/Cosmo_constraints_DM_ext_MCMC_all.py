...
RESUME = True
CKP_INTERVAL = 50
DATA_FILE = './DM_ext_all_checkpoint/simulation_data_z_02.pkl'
MCMC_FILE = './DM_ext_all_checkpoint/mcmc_checkpoint_z_02.pkl'

# savefile
DATA_FIG='./plot/data_cluster_DM_ext_all_z_02.pdf'
SAVE_RESULT='./posterior/cluster_MCMC_DM_ext_all_z_02.npy'
SAVE_FIG='./plot/MCMC_cluster_DM_ext_all_z_02'
