...
MCMC_FILE = './DM_diff_checkpoint/mcmc_checkpoint_z_later.pkl'

# savefile
DATA_FIG='./plot/data_cluster_DM_diff_z_later.pdf'
SAVE_RESULT='./posterior/cluster_MCMC_DM_diff_FRB_z_later.npy'
SAVE_FIG='./plot/MCMC_cluster_DM_diff_z_later'
